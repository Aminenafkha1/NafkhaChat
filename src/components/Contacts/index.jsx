...
const Contacts = ({ contacts, currentChat, setCurrentChat, currentUser }) => {
    ...
    <>
      <Container>
        ...
        <div className="contacts">
          {contacts?.map((contact, index) => {
            return (
              <div
                key={contact?.id}
                className={`contact ${contact?.id === currentChat?.id ? "selected" : ""
                  }`}
        ...
        <div className="current-user">
          ...
          >
            <img src={currentUser.avatarImage || defaultAvatar} alt="avatar" />
